...
class WeatherTabBarController: UITabBarController, CLLocationManagerDelegate {
    ...
    func getWeatherData(){
        let urla = WeatherURL(lat: String(coords.latitude), long: String(coords.longitude)).getFullURL()
        print(urla)
